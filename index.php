...
<body class="theme-red">
  ...
  <div class="vg-page page-home" id="home" style="background-image: url(assets/img/said.webp)">
    <!-- Navbar -->
    ...
    <div class="caption-header text-center wow zoomInDown">
      ...
      <h1 class="fw-light mb-4">I'm <b class="fg-theme">Said</b> Sayed</h1>
      <div class="badge">Back End Developer</div>
        ...
        <?php foreach ($categories as $category) { ?>
          <div class="col-md-6">
            <div class="px-lg-3">
              ...
              <h4 class="wow fadeInUp"><?= $category['name'] ?></h4>
              <?php foreach ($skills as $skill) {
                if ($category['id'] == $skill['category_id']) { ?>
                  ...
                  <div class="progress-wrapper wow fadeInUp">
                    ...
                    <div class="progress">
                      <div class="progress-bar" role="progressbar" style="width:<?= $skill['progress'] . "%" ?>;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><?= $skill['progress'] . "%" ?></div>
                    </div>
                  </div>
              <?php }
              } ?>
      ...
      <div class="row">
        <?php foreach ($categoriesCourses as $categoryCourse) { ?>
          <div class="col-md-6 wow fadeInRight">
            <h2 class="fw-normal"><?= $categoryCourse['name'] ?></h2>
            <?php foreach ($courses as $course) { ?>
              <ul class="timeline mt-4 pr-md-5">

                <?php if ($categoryCourse['id'] ==  $course['course_category']) { ?>
                  <li>
                    <div class="title"><?= $course['year'] ?></div>
                    <div class="details">
                      <h5><?= $course['name'] ?></h5>
                      <small class="fg-theme"><?= $course['slug'] ?></small>
                      <p><?= $course['desc'] ?></p>
                    </div>
                  </li>
                <?php } ?>
        ...
        <?php foreach ($services as $service) { ?>
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card card-service wow fadeInUp">
              <div class="icon">
                <span class="ti-paint-bucket"><i class="<?= $service['icon'] ?>"></i></span>
              </div>
              <div class="caption">
                <h4 class="fg-theme"><?= $service['name'] ?></h4>
                <p><?= $service['desc'] ?></p>
              </div>
            </div>
          </div>
      ...
      <div class="row section-counter">
        <?php foreach ($numbers as $number) { ?>
          <div class="col-md-6 col-lg-3 py-4 wow fadeIn">
            <h1 class="number" data-number="<?= $number['num'] ?>"><?= $number['num'] ?></h1>
